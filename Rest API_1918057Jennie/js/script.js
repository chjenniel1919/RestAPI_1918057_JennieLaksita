const ApiKey = "2141ab6674c34c47983a7495b9e8b49d";
...
function ShowTeamInfo(id) {
    title.innerHTML = "Informasi Detail Terkait Tim Liga Primer Inggris";
    let url = baseUrl + "teams/" + id;
    ...
    fetch(url, fetchHeader)
      ...
      .then((resJson) => {
        ...
        contents.innerHTML = `
               <h2 class="header center">${resJson.name}</h2>
                      ...
                      <div class="card-stacked">
                        <div class="card-content">
                          <p>id           : ${resJson.id}<br>
                             ...
                             ShortName    : ${resJson.shortName}<br>
                             TLA          : ${resJson.tla} <br>
                             Adress       : ${resJson.address} <br>
                             Website      : ${resJson.website} <br>
                             Email        : ${resJson.email} <br>
                             Founded      : ${resJson.founded} <br>
                             ClubColors   : ${resJson.clubColors} <br>
